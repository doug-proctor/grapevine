...
export const amenitiesQuery = defineQuery(`*[_type in ["amenity"]][0..5]{_id, name, svg_icon}`)
export const amenitiesFullQuery = defineQuery(`*[_type in ["amenity"] && promoted == true]{_id, name, description, picture}`)
